...
If you see the message **"Your branding needs to be verified,"** it means Google is protecting users from unknown apps. Until you finish this, the name **Glinto** won't show to everyone.
...
This is the **only way** to remove the "unverified" warning and show the name **Glinto** professionally:
1. Buy a domain (e.g., `Glinto.io` or `Glinto.com`).
...
2. Click **Advanced**.
3. Click **Go to Glinto (unsafe)** at the bottom.
