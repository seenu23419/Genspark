...
const DailyChallenge: React.FC = () => {
  ...
  return (
    <div className="bg-slate-900 border-2 border-slate-800 p-2 sm:p-3 md:p-6 md:p-8 rounded-lg md:rounded-[2rem] md:rounded-[2.5rem] flex flex-col md:flex-row items-start md:items-center justify-between gap-1.5 sm:gap-2 md:gap-4 hover:border-orange-500/30 transition-all shadow-xl">
      <div className="flex items-start md:items-center gap-1.5 sm:gap-2 md:gap-4 flex-1 w-full">
      ...
      <div className="flex flex-col gap-1 sm:gap-1.5 md:gap-3 w-full md:w-auto">
        ...
        <button
          ...
          className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-500 text-white px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-lg font-bold flex items-center justify-center md:justify-start gap-0.5 sm:gap-1 md:gap-2 text-[8px] sm:text-[9px] md:text-sm whitespace-nowrap"
        >
