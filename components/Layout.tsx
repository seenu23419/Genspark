    ...
    return (
        <div className="flex h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-slate-200 overflow-hidden font-sans selection:bg-indigo-500/30 transition-colors duration-300">
            ...
            <div className="flex-1 flex flex-col min-w-0 relative">
                ...
                <main className={`flex-1 overflow-y-auto scroll-smooth relative no-scrollbar animate-in fade-in duration-300 bg-slate-100 dark:bg-black transition-colors duration-300`}>
                    {children}
                </main>

                {/* Mobile Bottom Navigation - Improved visibility and safe-area support */}
                {!hideBottomNav && (
                    <div className="md:hidden sticky bottom-0 left-0 right-0 z-[100] bg-slate-100/80 dark:bg-black/80 backdrop-blur-2xl border-t border-slate-200 dark:border-white/10 pb-[env(safe-area-inset-bottom)] shadow-[0_-4px_20px_rgba(0,0,0,0.05)] dark:shadow-[0_-8px_30px_rgba(0,0,0,0.5)]">
